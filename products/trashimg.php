...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="restoreimg.php?id=<?php echo $row['id'];  ?>" class="btn btn-primary">Restore</a></td>
      <td><a href="permanentdelimg.php?id=<?php echo $row['id'];  ?>" class="btn btn-danger">Delete</a></td>
    </tr>
    <?php
    }
    ?>
